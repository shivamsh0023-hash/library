                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imgs/general%20user.jpg"/>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge badge-pill badge-info" ID="Label" runat="server" Text="Your Status"></asp:Label>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge badge-pill badge-info" ID="Labell" runat="server" Text="Your books info"></asp:Label>
                                </center>
                            </div>
                        </div>
